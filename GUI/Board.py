...
class Board:
    ...
    def update(self):
        ...
        if not (len(valid.get_valid_moves(self.array, self.player)) == 0 and
            ...
            if black_cnt + white_cnt == 64 or (
                    len(valid.get_valid_moves(self.array, 0)) == 0 and len(valid.get_valid_moves(self.array, 1))):
                self.over = True
    ...
    def draw_score_board(self):
        ...
        screen.create_text(80, 550, anchor="w", tags="score", font=("Consolas", 20), fill="white",
                           text=str(single_time_white.seconds // 60) + ':' + str(single_time_white.seconds % 60) + '/')
